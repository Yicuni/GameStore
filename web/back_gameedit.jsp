        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">修改成你想修改的样子吧~</h4>
                            <p class="card-description">
                                请在下面开始您的操作~
                            </p>
<%--                            enctype="multipart/form-data"--%>
                            <form class="forms-sample" action="${pageContext.request.contextPath}/updateGame?gameId=${game.gameId}"
                                  method="post">
                                <input type="hidden" name="gameId" value="${game.gameId}">
                                <div class="form-group">
                                    <label>游戏封面</label><br/>
                                    <img src="${pageContext.request.contextPath}/file/${game.filename}" alt="..."
                                         style="width: 169px;height: 94px;border-radius: 10px;"/><br/>
                                </div>
                                <div class="form-group">
                                    <label>游戏名称</label>
                                    <input type="text" class="form-control" value="${game.title}"
                                           name="title">
                                </div>
                                <div class="form-group">
                                    <label>游戏短介</label>
                                    <input type="text" class="form-control" value="${game.description}" name="description">
                                </div>
                                <div class="form-group">
                                    <label>游戏价格</label>
                                    <input type="number" class="form-control" value="${game.price}"
                                           name="price">
                                </div>
                                <div class="form-group">
                                    <label>销量</label>
                                    <input type="number" class="form-control" value="${game.saleNum}"
                                           name="saleNum">
                                </div>
                                <div class="form-group">
                                    <label>发布时间</label>
                                    <input type="date" class="form-control" value="${game.releaseDate}"
                                           name="releaseDate" style="height: 2.7rem;font-size: 1rem">
                                </div>

                                <div class="form-group">
                                    <select class="form-select form-check-inline" name="type"
                                            style="width: 200px;" >
...
<%--                                <div class="form-group">--%>
<%--                                    <label>原游戏封面</label><br/>--%>
<%--                                    <img src="${pageContext.request.contextPath}/file/${game.filename}" alt="..."--%>
<%--                                         style="width: 169px;height: 94px;border-radius: 10px;"/><br/>--%>
<%--                                    <label>新游戏封面</label>--%>
<%--                                    <input type="file" class="form-control" style="height: 2.7rem;font-size: 1rem" name="filename"><br/>--%>
<%--                                    <input type="hidden" name="upload" value="${game.filename}"><br>--%>
<%--                                    <input type="file" class="form-control" placeholder="游戏封面" name="upload">--%>
<%--                                </div>--%>
                                <button type="submit" class="btn btn-primary me-2">开始修改吧~</button>
                            </form>
                        </div>
                    </div>
                </div>
